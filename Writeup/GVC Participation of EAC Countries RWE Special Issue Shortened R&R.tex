...
\begin{table}[h!]
  ...
  \resizebox{\textwidth}{!}{
   \begin{tabular}{lcccccccc}
      ...
      F-test (IV only)        &                & 23.94                 & 24.64                 & 5.963                 &          & 23.55                 & 24.38                 & 20.88\\  
      Wald (IV only), p-value &                & 0.1555                & 0.1714                & 0.0049                &          & $<0.001$  & $<0.001$  & $<0.001$\\   
      \midrule
       \emph{Variables}\\
      ...
      F-test (IV only)        &                    & 0.1603                & 0.0497                 & 0.9349                &                    & 14.82                 & 10.52                  & 34.23\\  
      Wald (IV only), p-value &                    & 0.8704                & 0.9511                 & 0.8064                &                    & 0.0018                & 0.0050                 & $<0.001$\\  
      \midrule
      \emph{Fixed-effects}\\
...
\begin{table}[h!]
  ...
  \resizebox{\textwidth}{!}{
   \begin{tabular}{lcccccccc}
      ...
      F-test (IV only)        &                    & 5.067                 & 4.424                  & 27.67                 &                    & 17.06                 & 16.72                  & 11.07\\  
      Wald (IV only), p-value &                    & 0.4752                & 0.5593                 & 0.0090                &                    & 0.0002                & 0.0002                 & $<0.001$\\   
      \midrule
       \emph{Variables}\\
      ...
      F-test (IV only)        &                    & 193.4                  & 216.3                  & 260.1                  &                    & 4.252                 & 4.759                  & 2.324\\  
      Wald (IV only), p-value &                    & $<0.001$               & $<0.001$               & $<0.001$               &                    & 0.0003                & 0.0003                 & 0.0077\\  
      \midrule
      \emph{Fixed-effects}\\
