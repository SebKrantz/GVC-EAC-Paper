...
In light of the known macroeconomic inconsistencies in EORA data for EAC countries, and that VA flows are estimated from gross flows, it is useful to first consider gross trade flows in more details, before diving into detailed decompositions and value-added flows. For comparison, I also consider aggregated trade data from CEPII's BACI \citep{CEPIIBACI} (HS 1996 version) and the IMF's Direction of Trade Statistics (DOTS) \citep{IMFDOTS} databases. \newline
...
In all databases, trade with ROW dominates inner-EAC trade. To quantify these diagrams: according to BACI, inner EAC trade is 15.4 times smaller than EAC trade with ROW, according to DOT is 14 times smaller, EORA 17.6 times smaller, and EMERGING 27.1 times smaller. Figure \ref{fig:EAC_ROW_Ratios} shows the evolution of this ratio, computed from different databases (excluding EMERGING), over time, indicating that since around 2010 there is no sizeable progress in regional integration in relative gross trade terms. 
...
According to all databases, Uganda, and, to a lesser extent, Tanzania, are large suppliers of agricultural produce in inner-EAC trade. All countries have some stakes in processed foods and beverages. In manufacturing, Kenya has a distinct lead, followed by Tanzania and Uganda. A similar sectoral trading pattern is visible with ROW. All EAC countries are large agricultural exporters and importers of manufactured products. The data thus expound an imbalance in the nature of trade both within the EAC and ROW, which may complicate the formation of regional value chains. A more balanced trading pattern in the EAC exists for foods and beverages, which has also been the focus of EAC policy makers and regional studies, such as \citet{Daly2017RVCs} which show that while Uganda exports diary and maize produce to Kenya for processing, it has also received FDI and begun to upgrade its own food processing sector. The Ugandan Ministry of Finance and Planning, IGC Uganda (e.g. \citet{EGF21}, \citet{fowler2019agro}) and IFPRI \citep{van2020institutional} have also identified agro-industrialization as an important pillar of growth and transformation for the country. \newline 

Figure \ref{fig:EAC_ROW_Ratios_Sec} shows corresponding ratios of EAC-ROW to inner-EAC trade, indicating that inner-EAC trade in agriculture and, to a lesser extent, foods and beverages in the EAC holds increasing shares of overall EAC trade in these sectors. In 2020, the inner-EAC trade in agricultural products was 8 times smaller than EAC-ROW trade, down from 15 times smaller in 2005 according to BACI estimates. Similarly, for Foods \& Beverages inner-EAC trade was 5 times smaller in 2020, compared to 10 times smaller in 2005. These developments are also reflected in the MRIO databases. In constrast, trade in manufactures shows no such trends, and ROW-EAC trade is estimated $>$15 times more significant than inner-EAC trade in 2020. 
